...
public class AVersion {
    ...
    public String toString() {
        ...
        sb.append(", jarFilePath=").append(jarFilePath);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getVersionId() == null ? other.getVersionId() == null : this.getVersionId().equals(other.getVersionId()))
            ...
            && (this.getJarFilePath() == null ? other.getJarFilePath() == null : this.getJarFilePath().equals(other.getJarFilePath()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getJarFilePath() == null) ? 0 : getJarFilePath().hashCode());
